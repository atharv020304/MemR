...
class SnapshotLoader:
    ...
    async def _hydrate(
        ...
        for meta in metas:
            # Pre-check: if this snapshot's known token count would bust
            # the budget, skip it (don't even read the file)
            ...
            # Post-check: actual content might differ from indexed count
        ...
        return LoadResult(snapshots=snapshots, total_tokens=tokens_used)
